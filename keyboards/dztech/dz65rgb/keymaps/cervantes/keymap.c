...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_65_ansi( /* Base */
      ...
      MO(1),    KC_LGUI,  KC_LALT,                      KC_SPC,                       KC_RALT,  MO(1),    KC_RCTL,            KC_LEFT,  KC_DOWN,   KC_RIGHT),
  [1] = LAYOUT_65_ansi( /* FN */
      ...
      _______,  _______,  KC_LCA,                       _______,                      _______,  _______,  _______,            KC_MPRV,  KC_VOLD,   KC_MNXT),
};
