...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_65_ansi( /* Base */
      ...
      MO(1),    KC_LALT,  KC_LGUI,                      KC_SPC,                       KC_RGUI,  KC_RALT,  KC_RCTL,            KC_LEFT,  KC_DOWN,   KC_RIGHT),
  [1] = LAYOUT_65_ansi( /* FN */
      ...
      KC_CAPS,  RGB_SPI,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            EEP_RST,   _______, \
      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            KC_VOLU,   KC_MUTE, \
      _______,  KC_LCA,   _______,                      _______,                      _______,  _______,  _______,            KC_MPRV,  KC_VOLD,   KC_MNXT),
};
