...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    MO(1),    KC_LGUI,  KC_LALT,                      MS_SPC,   MS_SPC,   MS_SPC,                       KC_RALT,  MO(1),    KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  ...
  [1] = LAYOUT(
    ...
    _______,  _______,  KC_LCA,                       _______,  _______,  _______,                      _______,  _______,  _______,  _______,  KC_VOLD,  _______
  ),
